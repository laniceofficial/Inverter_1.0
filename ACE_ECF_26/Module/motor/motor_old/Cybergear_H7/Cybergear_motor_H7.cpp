 ...
 *  demo：
 *      cybergear_motor_c* MI_motor = new cybergear_motor_c(&hcan1,0,127);
        while(1)
        {
 ...
 * v3.0   此版本为H7 fdcan经典模式专用，修改完善了demo例子
 ************************** Dongguan-University of Technology -ACE***************************/
#include "Cybergear_motor_H7.hpp"
...
//函数声明
void MI_motor_recive_callback(BSP_CAN_Part_n::FDCANInstance_c* register_instance);
...
//小米电机构造函数
cybergear_motor_c::cybergear_motor_c(FDCAN_HandleTypeDef *phcan,uint8_t master_id,uint8_t motor_id):motor_can_ins_(phcan,master_id,motor_id,FDCAN_EXTENDED_ID,MI_motor_recive_callback)
{
