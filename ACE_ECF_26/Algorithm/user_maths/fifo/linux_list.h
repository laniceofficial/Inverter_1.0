 ...
 *    static __inline void list_add(list_t *new_, list_t *head)
 *    static __inline void list_add_tail(list_t *new_, list_t *head)
 *    static __inline void list_del(list_t *entry)
 *    static __inline void list_del_init(list_t *entry)
 *    static __inline void list_replace(list_t *old, list_t *new_)
 ...
 */
static __inline void __list_add(list_t *new_,
                                list_t *prev,
                                list_t *next)
{
  next->prev = new_;
