...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PB2     ------> ADC2_IN12
    */
    GPIO_InitStruct.Pin = AC3_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AC3_V_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = AC2_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AC2_V_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = AC1_I_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AC1_I_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB13     ------> ADC3_IN5
    */
    GPIO_InitStruct.Pin = AC2_I_Pin|AC1_V_Pin|DC1_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PB15     ------> ADC4_IN5
    */
    GPIO_InitStruct.Pin = DC1_I_Pin|DC2_I_Pin|DC2_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  */
    ...
    PA9     ------> ADC5_IN2
    */
    GPIO_InitStruct.Pin = DC3_I_Pin|DC3_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB2     ------> ADC2_IN12
    */
    HAL_GPIO_DeInit(AC3_V_GPIO_Port, AC3_V_Pin);

    HAL_GPIO_DeInit(AC2_V_GPIO_Port, AC2_V_Pin);

    HAL_GPIO_DeInit(AC1_I_GPIO_Port, AC1_I_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB13     ------> ADC3_IN5
    */
    HAL_GPIO_DeInit(GPIOB, AC2_I_Pin|AC1_V_Pin|DC1_V_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB15     ------> ADC4_IN5
    */
    HAL_GPIO_DeInit(GPIOB, DC1_I_Pin|DC2_I_Pin|DC2_V_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PA9     ------> ADC5_IN2
    */
    HAL_GPIO_DeInit(GPIOA, DC3_I_Pin|DC3_V_Pin);
